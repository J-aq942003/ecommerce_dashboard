"use client";
import "@/style/components/shared/SideBar/SideBarLargeDevices.css";
...
const SideBarLargeDevices = () => {
  ...
  useEffect(() => {
    ...
    console.log("colors: ", ProjectColors.BACKGROUND_PRIMARY);
  }, []);
  return (
    <aside
      className={`side-bar-large-device border-2ff border-green-400 h-full not-dark:bg-[${ProjectColors.BACKGROUND_PRIMARY}] dark:bg-[${ProjectColors.BACKGROUND_DARK}]ff`}
    >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  ...
                  <SideBarDropDown
                    ...
                    title="Invoice"
                    icon={<LiaFileInvoiceDollarSolid className="text-[20px]" />}
                  />
                  <div>
...
export default SideBarLargeDevices;
